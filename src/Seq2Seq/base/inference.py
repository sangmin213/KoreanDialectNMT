...
def translate_sentence(model, model_type, SRC, TRG, tokenized_sentence, input_level, device):
    model.eval()
...
def save_log(path, model, model_type, SRC, TRG, test_pair, input_level, device):
    result = []
